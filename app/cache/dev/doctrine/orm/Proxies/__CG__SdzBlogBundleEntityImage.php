...
namespace Proxies\__CG__\Sdz\Blog\Bundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Image extends \Sdz\Blog\Bundle\Entity\Image implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Sdz\\Blog\\Bundle\\Entity\\Image' . "\0" . 'id', '' . "\0" . 'Sdz\\Blog\\Bundle\\Entity\\Image' . "\0" . 'url', '' . "\0" . 'Sdz\\Blog\\Bundle\\Entity\\Image' . "\0" . 'alt', '' . "\0" . 'Sdz\\Blog\\Bundle\\Entity\\Image' . "\0" . 'file', '' . "\0" . 'Sdz\\Blog\\Bundle\\Entity\\Image' . "\0" . 'tempFilename');
        }
